...
# Problem ID: typical90_an ( https://atcoder.jp/contests/typical90/tasks/typical90_an )
# Title: 040. Get More Money（★7）
# Language: Python (3.8.2)
# Submitted: 2021-05-20 00:00:46 +0000 UTC ( https://atcoder.jp/contests/typical90/submissions/22740365 ) 

from collections import deque


# 最大フロー
# https://github.com/shakayami/ACL-for-python/blob/master/maxflow.py
...
for i in range(N):
    mf.add_edge(start, i, a[i])
    mf.add_edge(i, end, W)
    for j in range(len(c[i])):
        mf.add_edge(c[i][j]-1, i, inf)
